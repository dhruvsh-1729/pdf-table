...
// Main Component
export default function TagsPage({ tags, total, currentPage, totalPages, pageSize, filters }: TagsPageProps) {
          ...
          <>
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="text-sm text-gray-500">
                Showing {(currentPage - 1) * pageSize + 1}-{Math.min((currentPage - 1) * pageSize + tags.length, total)} of {total}
              </div>
            </div>
